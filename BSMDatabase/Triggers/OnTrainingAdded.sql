/*
---------------------------------------------------------------------------
Name         : bsm.OnTrainingAdded
---------------------------------------------------------------------------
Description  : Creates the audit entry when a new training is added
---------------------------------------------------------------------------
TFS Object   : **
---------------------------------------------------------------------------
...
---------------------------------------------------------------------------
*/
CREATE TRIGGER bsm.OnTrainingAdded
...
BEGIN	
	...
	SELECT @actionString = 'Entered ''' + @trainingName + ' for Dept ' + @skillsDeptName + ' - ' + @skillsName + ' for Employee: ' + @jobTitle + ' (' + @employeeName + ')';
